...
/* the above sql string can alse be written like this: 
`WITH Men AS (
...
/* as above, calling a sql statement inside parenthesis(nesting statements) is a way to avoid CROSS JOIN when calculating the percentage
*/
